...
This agent leverages the Template Creator MCP to extract reusable code templates from exemplar repositories and optionally raise GitHub pull requests with the generated files.
